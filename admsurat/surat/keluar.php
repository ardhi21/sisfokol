	...
	if (empty($no_surat))
		...
		if ($s == "baru")
			...
			if ($tcc != 0)
				...
				//insert
				mysql_query("INSERT INTO surat_keluar_disposisi (kd, kd_indeks, kd_surat, tgl_selesai, ".
				...
				//insert kendali
				mysql_query("INSERT INTO surat_keluar_kendali (kd, kd_indeks, kd_surat, tgl_selesai, ".
		...
		//jika update
			...
			{
			//query
			mysql_query("UPDATE surat_keluar SET no_urut = '$no_urut', ".
			...
			if ($tcc != 0)
				{
				//update
				mysql_query("UPDATE surat_keluar_disposisi SET kd_indeks = '$indeks', ".
			...
			if ($tcc != 0)
				{
				//update
				mysql_query("UPDATE surat_keluar_kendali SET kd_indeks = '$indeks', ".
						"tgl_selesai = '$tgl_selesai', ".
						"kepada = '$i_kepada', ".
						"tgl_kembali = '$tgl_kembali' ".
						"WHERE kd_surat = '$sukd'");
