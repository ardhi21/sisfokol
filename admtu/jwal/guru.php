...
if (empty($tapelkd))
	...
	$qjw = mysql_query("SELECT jadwal.*, jadwal.kd AS jkd, m_guru_prog_pddkn.*, m_guru.*, ".
				"m_prog_pddkn.*, m_kelas.*, m_hari.*, m_jam.*, m_keahlian.* ".
				...
				"ORDER BY m_keahlian.program ASC, m_kelas.no ASC, ".
	...
	if ($tjw == 0)
		...
		<td width="1">&nbsp;</td>
		<td width="150"><strong><font color="'.$warnatext.'">Program Keahlian</font></strong></td>
