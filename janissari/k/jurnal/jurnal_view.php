...
[<a href="jurnal_post.php?s=edit&jurkd='.$jurkd.'" title="EDIT">EDIT</a>]
<br>
...
//daftar komentar ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$qdko = mysql_query("SELECT * FROM user_blog_jurnal_msg ".
						"WHERE kd_user_blog_jurnal = '$jurkd' ".
...
if ($tdko != 0)
	...
	do
		...
		['.$dko_postdate.'].</em>
		[<a href="'.$filenya.'?jurkd='.$jurkd.'&msgkd='.$dko_kd.'&s=hapus" title="HAPUS"><img src="'.$sumber.'/img/delete.gif" width="16" height="16" border="0"></a>]
		<br><br>
		</td>
		</tr>
		</table>
...
<br>
<hr>
<big><strong>Jurnal Lainnya...</strong></big>
<br>';
...
$a_sqlcount = "SELECT * FROM user_blog_jurnal ".
...
if ($a_count != 0)
	...
	do
		...
		[<em>'.$dt_postdate.'</em>].
		[<a href="jurnal_view.php?jurkd='.$dt_kd.'" title="'.$dt_judul.'">...SELENGKAPNYA</a>]
		</LI>
		</UL>
		</td>
		</tr>';
	...
	{
	echo '<font color="red"><strong>BELUM ADA JURNAL LAINNYA.</strong></font>';
	}
