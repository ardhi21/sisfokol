...
if ($_POST['btnSMP'])
	...
	//re-direct
	$ke = "$filenya?uskd=$uskd&jurkd=$jurkd&page=$page";
	xloc($ke);
	exit();
	}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
$a_target = "$filenya?uskd=$uskd&jurkd=$jurkd";
...
if ($a_count != 0)
	...
	do
		...
		[<em>'.$dt_postdate.'</em>].
		[<a href="jurnal.php?uskd='.$uskd.'&jurkd='.$dt_kd.'&page='.$page.'" title="'.$dt_judul.'">...SELENGKAPNYA</a>]
		</LI>
		</UL>
		</td>
		</tr>';
	...
	{
	echo '<font color="blue"><strong>BELUM ADA JURNAL LAINNYA.</strong></font>';
	}
