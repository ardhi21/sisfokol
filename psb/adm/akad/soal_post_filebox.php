	...
	if (empty($filex_namex))
		...
		if ($ext_filex == ".jpg")
			...
			if (!file_exists($filex1)) 
				{	
				//mengkopi file
				move_uploaded_file($_FILES['filex']['tmp_name'],"../../../filebox/soal/$soalkd/$filex_namex"); 				 
			
				//query
				mysql_query("INSERT INTO psb_m_soal_filebox(kd, kd_mapel, kd_soal, filex) VALUES ".
...
//koleksi file
$qfle = mysql_query("SELECT * FROM psb_m_soal_filebox ".
						"WHERE kd_mapel = '$mapelkd' ".
						"AND kd_soal = '$soalkd' ".
						"ORDER BY filex ASC");
