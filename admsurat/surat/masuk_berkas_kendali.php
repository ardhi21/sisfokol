...
//nilai
$filenya = "masuk_berkas_kendali.php";
$judul = "Indeks Berkas Surat Masuk Kendali";
...
$sqlcount = "SELECT surat_masuk.*, surat_masuk.kd AS sukd, surat_masuk_kendali.* ".
		"FROM surat_masuk, surat_masuk_kendali ".
		"WHERE surat_masuk_kendali.kd_surat = surat_masuk.kd ".
		"AND surat_masuk_kendali.kd_indeks = '$inxkd' ".
		"ORDER BY surat_masuk.tgl_terima DESC";
$sqlresult = $sqlcount;
...
if ($count != 0)
	...
	do
		...
		echo '<td>
		<a href="masuk.php?s=edit&sukd='.$i_kd.'" title="EDIT">
		...
		<td>'.$dt4_map.'</td>
		<td>
		<a href="masuk_kendali.php?sukd='.$i_kd.'">
		<img src="'.$sumber.'/img/edit.gif" width="16" height="16" border="0">
		</a>
		<a href="masuk_kendali_pdf.php?sukd='.$i_kd.'" target="_blank">
	...
	<tr>
	<td>
	Total : <strong><font color="#FF0000">'.$count.'</font></strong> Data. '.$pagelist.'
	</td>
	</tr>
	</table>
	</p>';
...
//null
	...
	{
	echo '<p>
	<font color="red"><strong>TIDAK ADA DATA INDEKS BERKAS SURAT MASUK</strong></font>
	<p>';
	}
