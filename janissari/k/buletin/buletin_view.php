...
[<a href="buletin_post.php?s=edit&bulkd='.$bulkd.'" title="EDIT">EDIT</a>]
<br>
...
if ($tdko != 0)
	...
	do
		...
		['.$dko_postdate.'].</em>
		[<a href="'.$filenya.'?bulkd='.$bulkd.'&msgkd='.$dko_kd.'&s=hapus" title="HAPUS"><img src="'.$sumber.'/img/delete.gif" width="16" height="16" border="0"></a>]
		<br><br>
		</td>
		</tr>
		</table>
...
if ($a_count != 0)
	...
	do
		...
		[<em>'.$dt_postdate.'</em>].
		[<a href="buletin_view.php?bulkd='.$dt_kd.'" title="'.$dt_judul.'">...SELENGKAPNYA</a>]
		</LI>
		</UL>
		</td>
		</tr>';
	...
	{
	echo '<font color="red"><strong>BELUM ADA BULETIN LAINNYA.</strong></font>';
	}
