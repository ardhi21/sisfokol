...
if (empty($tapelkd))
	...
	<td width="50"><strong>Daftar Kompetensi</strong></td>
	<td width="50"><strong>Nilai Kompetensi</strong></td>
	<td width="50"><strong>Nilai Program Pendidikan</strong></td>
	</tr>';
	...
	if ($tdty != 0)
		...
		do
			...
			<td>
			<a href="ajar/daftar_kompetensi.php?mmkd='.$dty_gurkd.'&tapelkd='.$dty_tapelkd.'&kelkd='.$dty_kelkd.'&keahkd='.$dty_keahkd.'&mapelkd='.$dty_pelkd.'"
			title="Kelas = '.$ykel_kelas.', Keahlian = '.$yprog_keah.', Pelajaran = '.$dty_pel.'">
			<img src="'.$sumber.'/img/edit.gif" width="16" height="16" border="0"></a>
			</td>
			<td>
			<a href="ajar/nil_kompetensi.php?mmkd='.$dty_gurkd.'&tapelkd='.$dty_tapelkd.'&kelkd='.$dty_kelkd.'&keahkd='.$dty_keahkd.'&mapelkd='.$dty_pelkd.'"
			title="Kelas = '.$ykel_kelas.', Keahlian = '.$yprog_keah.', Pelajaran = '.$dty_pel.'">
			<img src="'.$sumber.'/img/edit.gif" width="16" height="16" border="0"></a>
			</td>
			<td>
