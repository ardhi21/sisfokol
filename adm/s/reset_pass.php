...
if ($_POST['btnRST'])
	...
	//nek sms akademik .....................................................................................................................
		...
		if (empty($pegawai))
			...
			//re-direct
			$pesan = "Silahkan tentukan dahulu yang menjadi Petugas SMS Akademik...";
			pekem($pesan,$ke);
			exit();
			}
		else
			...
			if ($tsuk != 0)
				{
				//update
				mysql_query("UPDATE admin_sms SET kd = '$x', ".
						"kd_pegawai = '$pegawai'");
				}
			else
				{
...
<option value="'.$filenya.'?tpkd=tp014&tipe=SMS Akademik">SMS Akademik</option>
</select>
</td>
</tr>
</table>';
