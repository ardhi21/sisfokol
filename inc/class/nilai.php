...
function HeaderKu()
	...
	//keahlian kompetensi
	$qpro2 = mysql_query("SELECT * FROM m_keahlian_kompetensi ".
				"WHERE kd = '$kompkd'");
	$rpro2 = mysql_fetch_assoc($qpro2);
	$pro2_komp = balikin($rpro2['kompetensi']);
	...
	$this->WriteHTML('<table width="600">'.
						...
						'<td width="120" height="30">Kompetensi</td>'.
						'<td width="3" height="30">: '.$pro2_komp.'</td>'.
						'</tr><tr>'.
						...
						'</tr><tr>'.
						'<td width="120" height="30">Bidang</td>'.
						'<td width="10" height="30">: '.$pro_bidang.'</td>'.
						'<td width="250" height="30">&nbsp;</td>'.
						'<td width="120" height="30">Tingkat</td>'.
						'<td width="3" height="30">: '.$rkel.'</td>'.
						'</tr><tr>'.
						'<td width="120" height="30">Program</td>'.
						'<td width="10" height="30">: '.$pro_program.'</td>'.
						'<td width="250" height="30">&nbsp;</td>'.
						'<td width="120" height="30">Semester</td>'.
						'<td width="3" height="30">: '.$smtno.' ('.$smt.')</td>'.
						'</tr>'.
						'</table>'.
						'<table width="600"><tr><td width="600" height="20"><hr></td></tr></table>');
