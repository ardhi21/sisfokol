...
if ($_POST['btnSMP'])
	...
	//re-direct
	$ke = "$filenya?tapelkd=$tapelkd&keahkd=$keahkd&kelkd=$kelkd&crkd=$crkd&crtipe=$crtipe&kunci=$kunci&page=$page";
	xloc($ke);
	exit();
	}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
if (empty($tapelkd))
	...
	<option value="'.$filenya.'?tapelkd='.$tapelkd.'&keahkd='.$keahkd.'&kelkd='.$kelkd.'&crkd=cr01&crtipe=NIP&kunci='.$kunci.'">NIP</option>
	<option value="'.$filenya.'?tapelkd='.$tapelkd.'&keahkd='.$keahkd.'&kelkd='.$kelkd.'&crkd=cr05&crtipe=Nama&kunci='.$kunci.'">Nama</option>
	</select>
	...
	if (empty($s))
		...
		if ($count != 0)
			...
			do
				...
				echo '<td>
				<a href="'.$filenya.'?tapelkd='.$tapelkd.'&keahkd='.$keahkd.'&kelkd='.$kelkd.'&crkd='.$crkd.'&crtipe='.$crtipe.'&kunci='.$kunci.'&s=edit&pkd='.$i_kd.'" title="EDIT...">
	...
	//jika edit ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		<INPUT type="hidden" name="keahkd" value="'.$keahkd.'">
