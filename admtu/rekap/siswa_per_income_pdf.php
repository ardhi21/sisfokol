...
require("../../inc/class/siswa_per_income.php");
...
$judul = "Rekap Data Siswa (Berdasarkan Income ORTU)";
$judulz = $judul;
...
$q = mysql_query("SELECT m_siswa.*, ".
			...
			"m_siswa.kd AS mskd, m_siswa.nama AS msnama, ".
...
for ($we=0;$we<=($npage);$we++)
	...
	$pdf->SetY($pdf->GetY()-5);
	$pdf->SetX(249);
	$pdf->Cell(30,15,'PENGHASILAN',1,0,'C',1);
...
$pdf->WriteHTML($isi);
$pdf->Output("Rekap_siswa_per_income.pdf",I);
?>