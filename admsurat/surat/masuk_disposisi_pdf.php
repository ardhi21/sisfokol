...
$pdf->Cell(135,4,$sek_nama,0,0,'C');
$pdf->Ln();

$pdf->SetX(12);
$pdf->SetFont('Times','',8);
$pdf->Cell(135,4,$sek_alamat,0,0,'C');
$pdf->Ln();
$pdf->Ln();
...
$pdf->SetX(12);
$pdf->Cell(20,7,'  Diterima Tanggal',0,0,'L');

$pdf->SetX(55);
$pdf->Cell(97,7,'  : '.$x_terima_tgl.' '.$arrbln1[$x_terima_bln].' '.$x_terima_thn.'',0,0,'L');
