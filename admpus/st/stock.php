...
if ($s == "edit")
	...
	if ($count != 0)
		...
		<td width="50"><strong><font color="'.$warnatext.'">Sisa Barang</font></strong></td>
		</tr>';
		...
		do
			...
			$soki_total = round($soki_bagus + $soki_rusak + $soki_hilang);


			//sisa barang yang ada
			$i_sisa = round($soki_bagus + $soki_rusak) - $soki_dipinjam;
