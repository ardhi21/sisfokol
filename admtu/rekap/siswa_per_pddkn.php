...
if (empty($tapelkd))
	...
	if ($count != 0)
		{
		echo '<p>
		[<a href="siswa_per_pddkn_pdf.php?tapelkd='.$tapelkd.'"><img src="'.$sumber.'/img/pdf.gif" border="0" width="16" height="16"></a>]
		</p>
