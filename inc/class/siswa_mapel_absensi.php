...
function Header()
{
	...
	//mapel
	$qpel = mysql_query("SELECT * FROM m_mapel ".
				"WHERE kd = '$mapelkd'");
	$rpel = mysql_fetch_assoc($qpel);
	$pel_nama = balikin($rpel['pel']);
	...
	$this->Cell(275,5,'PRESENSI PESERTA DIDIK DALAM KBM',0,0,'C');
	$this->Ln();
	$this->Cell(275,5,'TAHUN PELAJARAN : '.$tapel.'',0,0,'C');
	$this->Ln();
	$this->Cell(275,5,'SEMESTER : '.$smt_smt.'',0,0,'C');
	}
