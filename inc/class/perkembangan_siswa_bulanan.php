...
function Header()
{
	...
	if ($this->PageNo() == 1)
		...
		$this->GetY();
		$this->Cell(150,5,'DATA PERKEMBANGAN SISWA PER BULAN',0,1,'C');
		$this->GetY()+7;
		$this->Cell(150,5,'TAHUN PELAJARAN : '.$tpx_thn1.'/'.$tpx_thn2.'',0,1,'C');
		$this->GetY()+7;
		$this->Cell(150,5,'BULAN : '.$bulanx.'',0,1,'C');
		$this->Ln();
		}
	}
