...
//	$this->Image(''.$sumber.'/img/logo.jpg',10,8,16);
	...
	$this->WriteHTML('<table width="600">'.
						'<tr align="left">'.
						'<td width="140" height="30">Bidang Keahlian</td>'.
						'<td width="10" height="30">: '.$pro_bidang.'</td>'.
						'<td width="350" height="30">&nbsp;</td>'.
						'<td width="140" height="30">Tahun Pelajaran</td>'.
						'<td width="3" height="30">: '.$tapel.'</td>'.
						'</tr><tr>'.
						'<td width="140" height="30">Program Keahlian</td>'.
						'<td width="10" height="30">: '.$pro_program.'</td>'.
						'<td width="350" height="30">&nbsp;</td>'.
						'<td width="140" height="30">Semester</td>'.
						'<td width="3" height="30">: '.$smt.'</td>'.
						'</tr><tr>'.
						'<td width="140" height="30">Kelas</td>'.
						'<td width="10" height="30">: '.$kelas.'</td>'.
						'<td width="350" height="30">&nbsp;</td>'.
						'<td width="140" height="30">Wali Kelas</td>'.
						'<td width="3" height="30">: '.$nwk.'</td>'.
						'</tr>'.
						'</table>'.
