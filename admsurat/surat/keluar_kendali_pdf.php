...
require("../../inc/class/kendali_keluar.php");
...
$pdf->SetX(67);
$pdf->SetFont('Arial','',8);
$pdf->Cell(55,15,'Tgl. : '.$x_kirim_tgl.'/'.$x_kirim_bln.'/'.$x_kirim_thn.'',0,0,'L');
...
$pdf->WriteHTML($isi);
$pdf->Output("kendali_surat_keluar.pdf",I);
?>