...
if ($count != 0)
	...
	do
		...
		<td>'.$y_nama.'</td>
		<td>
		<a href="absensi.php?page='.$page.'&swkd='.$y_mskd.'&skkd='.$y_skkd.'&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&keahkd='.$keahkd.'&kompkd='.$kompkd.'"
		...
		<td>
		<a href="keuangan.php?page='.$page.'&swkd='.$y_mskd.'&skkd='.$y_skkd.'&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&keahkd='.$keahkd.'&kompkd='.$kompkd.'"
		title="Tahun Pelajaran = '.$pel_thn1.'/'.$pel_thn2.', Kelas = '.$kel_kelas.', Keahlian = '.$pro_bidang.' - '.$pro_program.'">
		<img src="'.$sumber.'/img/preview.gif" width="16" height="16" border="0"></a>
		</td>
		<td>
		<a href="raport.php?page='.$page.'&swkd='.$y_mskd.'&skkd='.$y_skkd.'&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&keahkd='.$keahkd.'&kompkd='.$kompkd.'"
		title="Tahun Pelajaran = '.$pel_thn1.'/'.$pel_thn2.', Kelas = '.$kel_kelas.', Keahlian = '.$pro_bidang.' - '.$pro_program.'">
