...
if ($_POST['btnCARI2'])
	...
	if (empty($kunci))
		...
		$sqlcount = "SELECT surat_masuk.*, surat_masuk.kd AS smkd, ".
				...
				"AND surat_masuk.kd_klasifikasi = surat_m_klasifikasi.kd ".
				"AND surat_masuk.kd_status = surat_m_status.kd ".
				"AND (surat_masuk.no_urut LIKE '%$kunci%' ".
				"OR surat_masuk.no_surat LIKE '%$kunci%' ".
				"OR surat_masuk.tujuan LIKE '%$kunci%' ".
				"OR surat_masuk.perihal LIKE '%$kunci%' ".
				...
				"OR surat_masuk.tgl_terima = '$dd_tgl_cari' ".
				"OR surat_masuk.tgl_surat = '$dd_tgl_cari' ".
				"OR surat_masuk.asal LIKE '%$kunci%') ".
