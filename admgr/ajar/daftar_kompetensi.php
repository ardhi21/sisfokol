...
if (empty($smtkd))
	...
	<input name="mpkd" type="hidden" value="'.$pelx_mpkd.'">
	<input name="mmkd" type="hidden" value="'.$mmkd.'">
	<input name="mkkd" type="hidden" value="'.$pelx_mkkd.'">
	...
	if ($total != 0)
		...
		do {
			...
			if ($i_sk == "0")
				...
				<td>
				<a href="'.$filenya.'?keahkd='.$keahkd.'&kompkd='.$kompkd.'&kelkd='.$kelkd.'&jnskd='.$jnskd.'&mkkd='.$mkkd.'&mkkd='.$mkkd.'&s=detail&kdx='.$i_kd.'">
				...
				<td>
				<a href="'.$filenya.'?keahkd='.$keahkd.'&kompkd='.$kompkd.'&kelkd='.$kelkd.'&jnskd='.$jnskd.'&mkkd='.$mkkd.'&mpkd='.$mkkd.'&s=detail&kdx='.$i_kd.'">
				<img src="'.$sumber.'/img/edit.gif" width="16" height="16" border="0">
				</a>
				</td>
				<td>'.$i_kode.'</td>
