...
<option value="'.$filenya.'?crkd=cr01&crtipe=NIP">NIP</option>
...
if ($count != 0)
	...
	do 
		...
		echo "<tr valign=\"top\" bgcolor=\"$warna\" onmouseover=\"this.bgColor='$warnaover';\" onmouseout=\"this.bgColor='$warna';\" onClick=\"document.formx.pg_kd.value='$i_kd';document.formx.pg_nip.value='$i_nip';document.formx.pg_nama.value='$i_nama';parent.pg_window.hide();\">";
		echo '<td width="50">
		'.$i_nip.'
		</td>
		<td>
	...
	<input id="pg_nip" name="pg_nip" type="hidden" value="">
	...
	echo '<p>
	<font color="red">
	<strong>TIDAK ADA DATA PEGAWAI...!!</strong>
	</font>
	</p>';
	}
