...
if ($_POST['btnSMP'])
	...
	//insert
	mysql_query("INSERT INTO guru_mapel_chatroom(kd, kd_guru_mapel, kd_user, msg, postdate) VALUES ".
...
echo '<body bgcolor='.$e_warna02.' text="#000000" leftmargin="0" topmargin="0" onLoad="go();document.formx.chat.focus();">
<form action="JavaScript: send()" method="get" name="formx">
<div id="view_ajax" style="overflow=auto; width: 920px; height: 500px; border: 1px;" align="left">
</div>
