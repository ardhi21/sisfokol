...
//PROSES ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//re-direct print...
$ke = "siswa_osis.php?tapelkd=$tapelkd&nis=$nis";
...
<P>
<big>
<strong><u>BUKTI PEMBAYARAN UANG OSIS</u></strong>
</big>
</P>
<P>
<big>
...
//yang telah dibayar
$qccx2 = mysql_query("SELECT SUM(nilai) AS nilai FROM siswa_uang_osis ".
			"WHERE kd_tapel = '$tapelkd' ".
			"AND kd_siswa = '$cc_kd'");
