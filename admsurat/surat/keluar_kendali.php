...
//nilai
$filenya = "keluar_kendali.php";
$judul = "Lembar Kartu Kendali";
...
//detail kendali
$qx2 = mysql_query("SELECT surat_keluar_kendali.*, ".
...
if ($_POST['btnSMP2'])
	...
	//cek
	$qcc = mysql_query("SELECT * FROM surat_keluar_kendali ".
				"WHERE kd_surat = '$sukd'");
	...
	if ($tcc != 0)
		{
		//update
		mysql_query("UPDATE surat_keluar_kendali SET tgl_selesai = '$tgl_selesai', ".
				"kepada = '$i_kepada', ".
		...
		{
		//insert
		mysql_query("INSERT INTO surat_keluar_kendali (kd, kd_surat, tgl_selesai, ".
...
if ($_POST['btnRST'])
	...
	//null-kan
	mysql_query("UPDATE surat_keluar_kendali SET tgl_selesai = '0000-00-00', ".
			"kepada = '-', ".
...
<td>:
<input name="lampiran" type="text" value="'.$x_lampiran.'" size="30" class="input" readonly>
</td>
</tr>
...
[<a href="keluar_kendali_pdf.php?sukd='.$sukd.'" target="_blank"><img src="'.$sumber.'/img/pdf.gif" border="0" width="16" height="16"></a>]

<input type="submit" name="btnDFT" value="DAFTAR KARTU KENDALI SURAT KELUAR >>">
<br>
<br>
<br>
</form>';
