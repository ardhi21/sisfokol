...
//nilai
$filenya = "siswa_bulanan_osis.php";
$judul = "Laporan Bulanan : Uang OSIS";
...
echo '</select>
[<a href="siswa_bulanan_osis_prt.php?tapelkd='.$tapelkd.'&utgl='.$utgl.'&ubln='.$ubln.'&uthn='.$uthn.'"><img src="'.$sumber.'/img/print.gif" border="0" width="16" height="16"></a>]
</td>
</tr>
</table>';
...
if (empty($tapelkd))
	...
	for ($i=1;$i<=$tkhir;$i++)
		...
		$qcc1 = mysql_query("SELECT m_siswa.*, ".
					...
					"AND round(DATE_FORMAT(siswa_uang_osis.tgl_bayar, '%d')) = '$i' ".
