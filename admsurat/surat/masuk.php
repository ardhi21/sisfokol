...
if ($_POST['btnSMP'])
	...
	if ((empty($no_surat)) OR (empty($asal)))
		...
		if ($s == "baru")
			{
			///cek
			$qcc = mysql_query("SELECT * FROM surat_masuk ".
			...
			if ($tcc != 0)
				...
				{
				//query
				mysql_query("INSERT INTO surat_masuk(kd, no_urut, kd_klasifikasi, kd_sifat, ".
						...
						"'$ruang', '$lemari', '$rak', '$map')");
                                ...
                                //insert disposisi
				mysql_query("INSERT INTO surat_masuk_disposisi (kd, kd_indeks, kd_surat, tgl_selesai, ".
				...
				//insert kendali
				mysql_query("INSERT INTO surat_masuk_kendali (kd, kd_indeks, kd_surat, tgl_selesai, ".
		...
		//jika update
			...
			{
			//query
			mysql_query("UPDATE surat_masuk SET no_urut = '$no_urut', ".
			...
			//cek disposisi
			$qcc = mysql_query("SELECT * FROM surat_masuk_disposisi ".
						"WHERE kd_surat = '$sukd'");
			$rcc = mysql_fetch_assoc($qcc);
			$tcc = mysql_num_rows($qcc);
			...
			if ($tcc != 0)
				{
				//update
				mysql_query("UPDATE surat_masuk_disposisi SET kd_indeks = '$indeks', ".
			...
			//cek kendali
			$qcc = mysql_query("SELECT * FROM surat_masuk_kendali ".
						"WHERE kd_surat = '$sukd'");
			$rcc = mysql_fetch_assoc($qcc);
			$tcc = mysql_num_rows($qcc);
			...
			if ($tcc != 0)
				{
				//update
				mysql_query("UPDATE surat_masuk_kendali SET kd_indeks = '$indeks', ".
						"tgl_selesai = '$tgl_selesai', ".
						"kepada = '$i_kepada', ".
						"tgl_kembali = '$tgl_kembali' ".
						"WHERE kd_surat = '$sukd'");
...
if ($_POST['btnHPS'])
	...
	do
		...
		//del
		mysql_query("DELETE FROM surat_masuk ".
				"WHERE kd = '$kd'");

		//hapus disposisi
		mysql_query("DELETE FROM surat_masuk_disposisi ".
				"WHERE kd_surat = '$kd'");
		}
...
if ($_POST['btnPRT'])
	...
	//re-direct
	$ke = "masuk_disposisi_pdf.php?sukd=$sukd";
	xloc($ke);
	exit();
	}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//daftar surat //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if ($count != 0)
		...
		do
			...
			//indeks berkas
			$qblsx2 = mysql_query("SELECT surat_m_indeks.*, surat_masuk_disposisi.* ".
						"FROM surat_m_indeks, surat_masuk_disposisi ".
						"WHERE surat_masuk_disposisi.kd_indeks = surat_m_indeks.kd ".
						"AND surat_masuk_disposisi.kd_surat = '$i_kd'");
