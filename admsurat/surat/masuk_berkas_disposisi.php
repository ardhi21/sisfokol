...
//nilai
$filenya = "masuk_berkas_disposisi.php";
$judul = "Indeks Berkas Surat Masuk Disposisi";
...
$sqlcount = "SELECT surat_masuk.*, surat_masuk.kd AS sukd, surat_masuk_disposisi.* ".
		"FROM surat_masuk, surat_masuk_disposisi ".
		"WHERE surat_masuk_disposisi.kd_surat = surat_masuk.kd ".
		"AND surat_masuk_disposisi.kd_indeks = '$inxkd' ".
