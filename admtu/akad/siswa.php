...
if ($_POST['btnEX'])
	...
	if ((empty($tapelkd)) OR (empty($kelkd)))
		...
		$worksheet1->write_string(0,1,"NISN");
		$worksheet1->write_string(0,2,"NAMA_LENGKAP");
		$worksheet1->write_string(0,3,"NAMA_PANGGILAN");
		...
		$worksheet1->write_string(0,8,"WARGA_NEGARA");
		$worksheet1->write_string(0,9,"ANAK_KE");
		$worksheet1->write_string(0,10,"JML_SDR_KANDUNG");
		$worksheet1->write_string(0,11,"JML_SDR_TIRI");
		$worksheet1->write_string(0,12,"JML_SDR_ANGKAT");
		$worksheet1->write_string(0,13,"BAHASA");
		$worksheet1->write_string(0,14,"ALAMAT");
		$worksheet1->write_string(0,15,"TELP");
		$worksheet1->write_string(0,16,"JARAK_TMP_TINGGAL");
		$worksheet1->write_string(0,17,"GOL_DARAH");
		$worksheet1->write_string(0,18,"PENYAKIT");
		$worksheet1->write_string(0,19,"KELAINAN");
		$worksheet1->write_string(0,20,"TB");
		$worksheet1->write_string(0,21,"BB");
		$worksheet1->write_string(0,22,"TAMAT_DARI");
		$worksheet1->write_string(0,23,"TGL_IJAZAH");
		$worksheet1->write_string(0,24,"NO_IJAZAH");
		$worksheet1->write_string(0,25,"LAMA_BELAJAR");
		$worksheet1->write_string(0,26,"DITERIMA_KELAS");
		$worksheet1->write_string(0,27,"TGL_DITERIMA");
		$worksheet1->write_string(0,28,"AYAH_NAMA");
		$worksheet1->write_string(0,29,"AYAH_TMP_NAMA");
		$worksheet1->write_string(0,30,"AYAH_TGL_LAHIR");
		$worksheet1->write_string(0,31,"AYAH_AGAMA");
		$worksheet1->write_string(0,32,"AYAH_WARGA_NEGARA");
		$worksheet1->write_string(0,33,"AYAH_PENDIDIKAN");
		$worksheet1->write_string(0,34,"AYAH_PEKERJAAN");
		$worksheet1->write_string(0,35,"AYAH_PENGHASILAN");
		$worksheet1->write_string(0,36,"AYAH_ALAMAT");
		$worksheet1->write_string(0,37,"AYAH_TELP");
		$worksheet1->write_string(0,38,"AYAH_HIDUP");
		$worksheet1->write_string(0,39,"IBU_NAMA");
		$worksheet1->write_string(0,40,"IBU_TMP_NAMA");
		$worksheet1->write_string(0,41,"IBU_TGL_LAHIR");
		$worksheet1->write_string(0,42,"IBU_AGAMA");
		$worksheet1->write_string(0,43,"IBU_WARGA_NEGARA");
		$worksheet1->write_string(0,44,"IBU_PENDIDIKAN");
		$worksheet1->write_string(0,45,"IBU_PEKERJAAN");
		$worksheet1->write_string(0,46,"IBU_PENGHASILAN");
		$worksheet1->write_string(0,47,"IBU_ALAMAT");
		$worksheet1->write_string(0,48,"IBU_TELP");
		$worksheet1->write_string(0,49,"IBU_HIDUP");
		$worksheet1->write_string(0,50,"WALI_NAMA");
		$worksheet1->write_string(0,51,"WALI_TMP_NAMA");
		$worksheet1->write_string(0,52,"WALI_TGL_LAHIR");
		$worksheet1->write_string(0,53,"WALI_AGAMA");
		$worksheet1->write_string(0,54,"WALI_WARGA_NEGARA");
		$worksheet1->write_string(0,55,"WALI_PENDIDIKAN");
		$worksheet1->write_string(0,56,"WALI_PEKERJAAN");
		$worksheet1->write_string(0,57,"WALI_PENGHASILAN");
		$worksheet1->write_string(0,58,"WALI_ALAMAT");
		$worksheet1->write_string(0,59,"WALI_TELP");
		$worksheet1->write_string(0,60,"GEMAR_SENI");
		$worksheet1->write_string(0,61,"GEMAR_OR");
		$worksheet1->write_string(0,62,"GEMAR_LAIN");
		$worksheet1->write_string(0,63,"BEA_SISWA");
		...
		do
			...
			$worksheet1->write_string($dt_nox,1,$dt_nisn);
			$worksheet1->write_string($dt_nox,2,$dt_nama);
			$worksheet1->write_string($dt_nox,3,$dt_panggilan);
			$worksheet1->write_string($dt_nox,4,$dt_kelamin);
			$worksheet1->write_string($dt_nox,5,$dt_tmp_lahir);
			$worksheet1->write_string($dt_nox,6,$dt_tgl_lahir);
			$worksheet1->write_string($dt_nox,7,$dt_agama);
			$worksheet1->write_string($dt_nox,8,$dt_warga_negara);
			$worksheet1->write_string($dt_nox,9,$dt_anak_ke);
			$worksheet1->write_string($dt_nox,10,$dt_jml_sdr_kandung);
			$worksheet1->write_string($dt_nox,11,$dt_jml_sdr_tiri);
			$worksheet1->write_string($dt_nox,12,$dt_jml_sdr_angkat);
			$worksheet1->write_string($dt_nox,13,$dt_bahasa);
			$worksheet1->write_string($dt_nox,14,$dt_alamat);
			$worksheet1->write_string($dt_nox,15,$dt_telp);
			$worksheet1->write_string($dt_nox,16,$dt_jarak);
			$worksheet1->write_string($dt_nox,17,$dt_gol_darah);
			$worksheet1->write_string($dt_nox,18,$dt_penyakit);
			$worksheet1->write_string($dt_nox,19,$dt_kelainan);
			$worksheet1->write_string($dt_nox,20,$dt_tb);
			$worksheet1->write_string($dt_nox,21,$dt_bb);
			$worksheet1->write_string($dt_nox,22,$dt_tamat_dari);
			$worksheet1->write_string($dt_nox,23,$dt_tgl_ijazah);
			$worksheet1->write_string($dt_nox,24,$dt_no_ijazah);
			$worksheet1->write_string($dt_nox,25,$dt_lama_belajar);
			$worksheet1->write_string($dt_nox,26,$dt_kelas);
			$worksheet1->write_string($dt_nox,27,$dt_tgl_diterima);
			$worksheet1->write_string($dt_nox,28,$dt_ayah_nama);
			$worksheet1->write_string($dt_nox,29,$dt_ayah_tmp_lahir);
			$worksheet1->write_string($dt_nox,30,$dt_ayah_tgl_lahir);
			$worksheet1->write_string($dt_nox,31,$dt_ayah_agama);
			$worksheet1->write_string($dt_nox,32,$dt_ayah_warga_negara);
			$worksheet1->write_string($dt_nox,33,$dt_ayah_pendidikan);
			$worksheet1->write_string($dt_nox,34,$dt_ayah_pekerjaan);
			$worksheet1->write_string($dt_nox,35,$dt_ayah_penghasilan);
			$worksheet1->write_string($dt_nox,36,$dt_ayah_alamat);
			$worksheet1->write_string($dt_nox,37,$dt_ayah_telp);
			$worksheet1->write_string($dt_nox,38,$dt_ayah_hidup);
			$worksheet1->write_string($dt_nox,39,$dt_ibu_nama);
			$worksheet1->write_string($dt_nox,40,$dt_ibu_tmp_lahir);
			$worksheet1->write_string($dt_nox,41,$dt_ibu_tgl_lahir);
			$worksheet1->write_string($dt_nox,42,$dt_ibu_agama);
			$worksheet1->write_string($dt_nox,43,$dt_ibu_warga_negara);
			$worksheet1->write_string($dt_nox,44,$dt_ibu_pendidikan);
			$worksheet1->write_string($dt_nox,45,$dt_ibu_pekerjaan);
			$worksheet1->write_string($dt_nox,46,$dt_ibu_penghasilan);
			$worksheet1->write_string($dt_nox,47,$dt_ibu_alamat);
			$worksheet1->write_string($dt_nox,48,$dt_ibu_telp);
			$worksheet1->write_string($dt_nox,49,$dt_ibu_hidup);
			$worksheet1->write_string($dt_nox,50,$dt_wali_nama);
			$worksheet1->write_string($dt_nox,51,$dt_wali_tmp_lahir);
			$worksheet1->write_string($dt_nox,52,$dt_wali_tgl_lahir);
			$worksheet1->write_string($dt_nox,53,$dt_wali_agama);
			$worksheet1->write_string($dt_nox,54,$dt_wali_warga_negara);
			$worksheet1->write_string($dt_nox,55,$dt_wali_pendidikan);
			$worksheet1->write_string($dt_nox,56,$dt_wali_pekerjaan);
			$worksheet1->write_string($dt_nox,57,$dt_wali_penghasilan);
			$worksheet1->write_string($dt_nox,58,$dt_wali_alamat);
			$worksheet1->write_string($dt_nox,59,$dt_wali_telp);
			$worksheet1->write_string($dt_nox,60,$dt_gemar_seni);
			$worksheet1->write_string($dt_nox,61,$dt_gemar_or);
			$worksheet1->write_string($dt_nox,62,$dt_gemar_lain);
			$worksheet1->write_string($dt_nox,63,$dt_bea_siswa);
			}
