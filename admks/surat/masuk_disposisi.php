...
if ($x2_pengesahan == "true")
	{
	$x2_pengesahan_ket = "SAH";
	}
else
	{
	$x2_pengesahan_ket = "Belum Sah";
	}
...
if ($_POST['btnSMP2'])
	...
	$status_sah = nosql($_POST['status_sah']);


	//update
	mysql_query("UPDATE surat_masuk_disposisi SET tgl_selesai = '$tgl_selesai', ".
			"isi = '$i_isi_disposisi', ".
			"diteruskan = '$i_diteruskan', ".
			"kepada = '$i_kepada', ".
			"tgl_kembali = '$tgl_kembali', ".
			"pengesahan = '$status_sah' ".
			"WHERE kd_surat = '$sukd'");
...
if ($_POST['btnRST'])
	...
	//null-kan
	mysql_query("UPDATE surat_masuk_disposisi SET tgl_selesai = '0000-00-00', ".
			"isi = '-', ".
			"diteruskan = '-', ".
			"kepada = '-', ".
...
Status Pengesahan :
<br>
<select name="status_sah">
<option value="'.$x2_pengesahan.'" selected>'.$x2_pengesahan_ket.'</option>
<option value="true">SAH</option>
<option value="false">Belum Sah</option>
</select>
</p>
</td>
</tr>
