...
//nilai
$filenya = "siswa_per_kerja.php";
$judul = "Rekap Data : Siswa (Berdasarkan Pekerjaan ORTU)";
...
if (empty($tapelkd))
	...
	$sqlcount = "SELECT m_siswa.*, ".
			...
			"m_siswa.kd AS mskd, m_siswa.nama AS swnama, ".
			"siswa_kelas.*, m_kelas.*, m_siswa_ayah.*, m_pekerjaan.* ".
			"FROM m_siswa, siswa_kelas, m_kelas, m_siswa_ayah, m_pekerjaan ".
			"WHERE siswa_kelas.kd_siswa = m_siswa.kd ".
			"AND siswa_kelas.kd_kelas = m_kelas.kd ".
			"AND m_siswa_ayah.kd_siswa = m_siswa.kd ".
			"AND m_siswa_ayah.kd_pekerjaan = m_pekerjaan.kd ".
			"AND siswa_kelas.kd_tapel = '$tapelkd' ".
			"ORDER BY m_pekerjaan.pekerjaan ASC";
	$sqlresult = $sqlcount;
	...
	if ($count != 0)
		{
		echo '<p>
		[<a href="siswa_per_kerja_pdf.php?tapelkd='.$tapelkd.'"><img src="'.$sumber.'/img/pdf.gif" border="0" width="16" height="16"></a>]
		</p>
