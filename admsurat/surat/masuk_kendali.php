...
if ($_POST['btnSMP2'])
	...
	if ($tcc != 0)
		{
		//update
		mysql_query("UPDATE surat_masuk_kendali SET tgl_selesai = '$tgl_selesai', ".
				"kepada = '$i_kepada', ".
		...
		{
		//insert
		mysql_query("INSERT INTO surat_masuk_kendali (kd, kd_surat, tgl_selesai, ".
...
if ($_POST['btnRST'])
	...
	//null-kan
	mysql_query("UPDATE surat_masuk_kendali SET tgl_selesai = '0000-00-00', ".
			"kepada = '-', ".
...
[<a href="masuk_kendali_pdf.php?sukd='.$sukd.'" target="_blank"><img src="'.$sumber.'/img/pdf.gif" border="0" width="16" height="16"></a>]

<input type="submit" name="btnDFT" value="DAFTAR KARTU KENDALI SURAT MASUK >>">
<br>
<br>
<br>
</form>';
