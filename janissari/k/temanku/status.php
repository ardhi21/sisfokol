...
$sqlcount = "SELECT m_user.*, user_blog_teman.*, ".
				"user_blog_status.*, user_blog_status.kd AS stkd ".
				"FROM m_user, user_blog_teman, user_blog_status ".
...
if ($count != 0)
	...
	do
		...
		[<a href="'.$filenya.'?page='.$page.'&bk=status&stkd='.$dt_kd.'#'.$dt_kd.'" title="Beri Komentar">Beri Komentar</a>]. ';
	...
	{
	echo '<br>
	<font color="red"><strong>TIDAK ADA DAFTAR STATUS TEMAN.</strong></font>';
	}
