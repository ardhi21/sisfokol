		...
		if ((empty($nip)) OR (empty($nama1)))
			...
			if ($tcc != 0)
				...
				mysql_query("INSERT INTO m_user(kd, usernamex, passwordx, nomor, nama, tipe, postdate) VALUES ".
						"('$x', '$x_userx', '$x_passx', '$nip', '$nama1', 'GURU', '$today')");
...
if (empty($s))
	...
	if ($count != 0)
		...
		do
			...
			//ubah nip, tanpa spasi.
			$i_msg = strtoupper($nip);
			...
			$j_ku = "$j_satu$j_dua$j_tiga$j_empat";
			$j_ku2 = md5($j_ku);



			//update
			mysql_query("UPDATE m_pegawai SET nip = '$j_ku', ".
					"usernamex = '$j_ku', ".
					"passwordx = '$j_ku2' ".
					"WHERE kd = '$kd'");
			...
			if ($tcc1 != 0)
				{
				//update ke janissari
				mysql_query("UPDATE m_user SET usernamex = '$usernamex', ".
						"passwordx = '$passwordx', ".
						"nomor = '$nip', ".
						"nama = '$nama' ".
						"WHERE kd = '$kd'");
				...
				//masukkan ke janissari
				mysql_query("INSERT INTO m_user(kd, usernamex, passwordx, nomor, nama, tipe, postdate) VALUES ".
						"('$kd', '$usernamex', '$passwordx', '$nip', '$nama', 'GURU', '$today')");
				}
