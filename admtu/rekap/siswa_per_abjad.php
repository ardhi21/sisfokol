...
//nilai
$filenya = "siswa_per_abjad.php";
$judul = "Rekap Data : Siswa (Berdasarkan Abjad)";
...
if (empty($tapelkd))
	...
	if ($count != 0)
		{
		echo '<p>
		[<a href="siswa_per_abjad_pdf.php?tapelkd='.$tapelkd.'"><img src="'.$sumber.'/img/pdf.gif" border="0" width="16" height="16"></a>]
		</p>
