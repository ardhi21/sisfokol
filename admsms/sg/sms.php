		...
		do
			...
			if ($i_Processed == "false")
				...
				if (($j_spp == "SPP") AND ($j_siswa == "SISWA"))
					...
					// membuat SMS balasan
					mysql_query("INSERT INTO outbox(DestinationNumber, TextDecoded, CreatorID) ".
							"VALUES ('$i_pengirim', '$dtu_statusx', 'Gammu')");
				...
				if ($tanggal == "10")
					...
					do
						...
						// membuat SMS massal
						mysql_query("INSERT INTO outbox(DestinationNumber, TextDecoded, CreatorID) ".
								"VALUES ('$cc_nohp', '$isi_sms', 'Gammu')");

						// membuat SMS massal
						mysql_query("INSERT INTO outbox(DestinationNumber, TextDecoded, CreatorID) ".
								"VALUES ('$cc_nohp2', '$isi_sms', 'Gammu')");
				...
				//cari tahu jadwal/////////////////////////////////////////////////////////////////////////////
				//format SMS : JADWAL#TAPEL#SMT#KELAS#KEAHLIAN#RUANG#HARI#JAM
				//ambil deretan sms
				$j_jadwal = $pecah[0];
				$j_tapel = $pecah[1];
				$j_smt = $pecah[2];
				...
				if ($j_jadwal == "JADWAL")
					...
					$qdte = mysql_query("SELECT jadwal.*, jadwal.kd AS jdkd, m_guru.*, ".
								...
								"AND jadwal.kd_keahlian = '$j_keahkd' ".
					...
					//isi sms
					$isi_sms = "Pada Jadwal ini, Program Pendidikan : $dte_pel, dengan Guru : $dte_nip.$dte_nama .";
